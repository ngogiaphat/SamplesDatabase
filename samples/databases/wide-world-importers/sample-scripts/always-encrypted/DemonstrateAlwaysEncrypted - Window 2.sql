...
-- This connection is used to simulate a client app note this demo is continued from the first demo window
...
-- can see the data. Remember that this can only work because the client happens to be the same machine as the server in our case.
