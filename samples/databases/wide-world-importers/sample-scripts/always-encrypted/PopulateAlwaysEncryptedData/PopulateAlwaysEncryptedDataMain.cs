            ...
            try {
                using(SqlConnection con = new SqlConnection(ConnectionStringTextBox.Text)){
                    ...
                    using(SqlCommand cmd = new SqlCommand()){
                        ...
                        cmd.ExecuteNonQuery();
                        cmd.CommandText = "INSERT Purchasing.Supplier_PrivateDetails" + "(SupplierID, NationalID, CreditCardNumber, ExpiryDate)" + "VALUES (@SupplierID, @NationalID, @CreditCardNumber, @ExpiryDate);";
